 ...
 * Provides smooth image loading with blur-up effect and performance optimization
 */
...
(function() {
    ...
    function init() {
        ...
        lazyImages.forEach(img => {
            ...
            // Store original src if using data-src
            if (img.dataset.src) {
                // Image is already set up with data-src
                imageObserver.observe(img);
            } else if (img.src && img.src !== '') {
                // Image has src, observe it for lazy loading
                imageObserver.observe(img);
            }
        });
    }
